    ...
    >
      ...
      <div className="relative hidden md:flex items-center ml-4">
        ...
        <input
          ...
          onFocus={e => {
            ...
            e.currentTarget.style.border = '1px solid rgba(255,59,48,0.4)'
            e.currentTarget.style.boxShadow = '0 0 0 3px rgba(255,59,48,0.12)'
          }}
          onBlur={e => {
      ...
      >
        ...
        <span
          ...
          style={{ background: '#FF3B30', boxShadow: '0 0 0 1.5px rgba(245,245,247,0.9)' }}
        />
      </motion.button>
